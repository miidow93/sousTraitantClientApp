...
export class ContentComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private service: VisiteurService, private router: Router) { }
  ...
  //   this.filteredSocietes = this.posteForm.controls['Societe'].valueChanges
  //   .pipe(
  //     startWith(''),
